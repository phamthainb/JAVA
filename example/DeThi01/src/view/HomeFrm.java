...
public class HomeFrm extends javax.swing.JFrame implements View {
    ...
    private DefaultTableModel modelStat;
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("QL Lái Xe", jPanel1);
        ...
        jTabbedPane2.addTab("QL Tuyến Xe", jPanel2);
        ...
        comboSortOptions.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sắp xếp theo tên lái xe", "Sắp xếp theo số lượng tuyến đảm nhận" }));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(52, 52, 52)
                        .addComponent(comboSortOptions, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTabbedPane2.addTab("QL Phân Công Lái Xe", jPanel3);
        ...
        tblStat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã LX", "Tên LX", "Tổng số lượt", "Tổng số tuyến", "Tổng khoảng cách"
            }
        ));
        jScrollPane5.setViewportView(tblStat);
        ...
        jTabbedPane2.addTab("Báo Cáo & Thống kê", jPanel5);
    ...
    private void comboSortOptionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboSortOptionsActionPerformed
        // TODO add your handling code here:
        int index = comboSortOptions.getSelectedIndex();
        if (index == 0) {
            ...
            if (t instanceof Manager) {
                ...
                for (Pair<Bus, Integer> pair : b.getPairs()) {
                    model.addRow(new Object[]{
                        ...
                        pair.getTuyen().getId(), pair.getSoLuot(),
                        b.getTongSoLuot(), b.getPairs().size()
                    });
                }
            }
        }
    ...
    private void showStat() {
        modelStat.setRowCount(0);
        controller.sortByTotalDistance(listManager);
        int i = 1;
        for (Manager m : listManager) {
            modelStat.addRow(new Object[]{
                i++, m.getDriver().getId(), m.getDriver().getName(), m.getTongSoLuot(),
